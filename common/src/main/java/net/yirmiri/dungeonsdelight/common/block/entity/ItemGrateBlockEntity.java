...
public class ItemGrateBlockEntity extends BlockEntity implements ItemGrateTooltip {
    ...
    public void insertItem(Level level, Player player, InteractionHand hand) {
        ItemStack held = player.getItemInHand(hand);
        if (!level.isClientSide && !held.isEmpty() && stack.isEmpty()) {
    ...
    public void takeItem(Level level, Player player) {
    ...
    public boolean hasAugs() {
        return waxed || fast || large;
    }
