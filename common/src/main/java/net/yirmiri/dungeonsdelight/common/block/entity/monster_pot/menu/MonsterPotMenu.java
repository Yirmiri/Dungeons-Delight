...
public class MonsterPotMenu extends RecipeBookMenu<Container> {
    ...
    public MonsterPotMenu(int id, Inventory playerInv) {
        this(id, playerInv, new SimpleContainer(MonsterPotBlockEntity.MAX_CONT_SIZE), new SimpleContainerData(2), ContainerLevelAccess.NULL);
    }
    ...
    public MonsterPotMenu(int id, Inventory playerInv, Container container, ContainerData data, ContainerLevelAccess access) {
        ...
        // Container + Output
        this.addSlot(new Slot(container, MonsterPotBlockEntity.BOWL_SLOT, 127, 57));
        this.addSlot(new PotOutputSlot(this.player, container, MonsterPotBlockEntity.OUTPUT_SLOT, 126, 26));
