...
public class DDItems {
    ...
    public static final Supplier<Item> STONE_CLEAVER = register("stone_cleaver", () -> new CleaverItem(0.6F, DungeonsDelight.CONFIG.getCleaverAttackDamage(), DungeonsDelight.CONFIG.getCleaverAttackSpeed() - 0.1F, DungeonsDelight.CONFIG.getCleaverChargeMultiplier() - 0.1F, Tiers.STONE, DDProperties.ItemP.STONE));
    ...
    public static final Supplier<Item> GOLDEN_CLEAVER = register("golden_cleaver", () -> new CleaverItem(1.5F, DungeonsDelight.CONFIG.getCleaverAttackDamage(), DungeonsDelight.CONFIG.getCleaverAttackSpeed() + 0.1F, DungeonsDelight.CONFIG.getCleaverChargeMultiplier(), Tiers.GOLD, DDProperties.ItemP.GOLD));
