...
//
//    public static final Supplier<RecipeSerializer<MonsterCookingRecipe>> MONSTER_COOKING_SERIALIZER = registerSerializer("monster_cooking",
//            new MonsterCookingRecipe.Serializer(MonsterCookingRecipe::new));
