...
public class NVEffects {
    public static final MobEffect NV_PEACE = RLServices.PLATFORM.isModLoaded(DDIntegration.NV_ID)
    ...
    public static Supplier<MobEffect> register(String id, Supplier<MobEffect> supplier) {
        return RLServices.REGISTRY.registerEffect(DDIntegration.NV_ID, id, supplier);
    }
