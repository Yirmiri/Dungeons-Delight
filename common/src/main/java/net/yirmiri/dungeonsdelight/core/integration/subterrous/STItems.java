...
public class STItems {
    public static final Supplier<Item> WOLFRAM_CLEAVER = register("wolfram_cleaver", () -> new CleaverItem(0.8F, DungeonsDelight.CONFIG.cleaverAttackDamage.getValue(), DungeonsDelight.CONFIG.cleaverAttackSpeed.getValue() - 0.2F, 0.8F, Tiers.valueOf("WOLFRAM"), DDProperties.ItemP.WOLFRAM));
