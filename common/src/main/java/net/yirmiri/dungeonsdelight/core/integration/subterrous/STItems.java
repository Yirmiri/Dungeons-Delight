...
public class STItems {
    public static final Supplier<Item> WOLFRAM_CLEAVER = register("wolfram_cleaver", () -> new CleaverItem(0.75F, DungeonsDelight.CONFIG.getCleaverAttackDamage(), DungeonsDelight.CONFIG.getCleaverAttackSpeed(), 0.75F, Tiers.valueOf("WOLFRAM"), DDProperties.ItemP.WOLFRAM));
