...
public class DDClientEvents {
    ...
    public static void registerBlockRenderLayers(final FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(DDBlocks.SPIRIT_FIRE.get(), RenderType.cutoutMipped());
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        Supplier<LayerDefinition> outer = () -> LayerDefinition.create(HumanoidModel.createMesh(new CubeDeformation(HumanoidModel.OVERLAY_SCALE), 0.0F), 64, 64);
