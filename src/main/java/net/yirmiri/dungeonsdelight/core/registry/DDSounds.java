...
public class DDSounds {
    ...
    public static final Supplier<SoundEvent> CLEAVER_SERRATED_STRIKE = SOUNDS.register("item.cleaver.serrated_strike", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "item.cleaver.serrated_strike")));

    //MONSTER YAM
    public static final Supplier<SoundEvent> MONSTER_YAM_AMBIENT = SOUNDS.register("entity.monster_yam.ambient", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "entity.monster_yam.ambient")));
    public static final Supplier<SoundEvent> MONSTER_YAM_HURT = SOUNDS.register("entity.monster_yam.hurt", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "entity.monster_yam.hurt")));
    ...
    public static final Supplier<SoundEvent> STAINED_SCRAP_BREAK = SOUNDS.register("block.stained_scrap.break", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "block.stained_scrap.break")));
    public static final Supplier<SoundEvent> STAINED_SCRAP_FALL = SOUNDS.register("block.stained_scrap.fall", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "block.stained_scrap.fall")));
    public static final Supplier<SoundEvent> STAINED_SCRAP_HIT = SOUNDS.register("block.stained_scrap.hit", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "block.stained_scrap.hit")));
    ...
    public static final Supplier<SoundEvent> ROT_AND_STEEL = SOUNDS.register("item.rot_and_steel.use", () -> SoundEvent.createVariableRangeEvent(RunicLib.customid(DungeonsDelight.MOD_ID, "item.rot_and_steel.use")));
