...
public class DDItems {
    ...
    //CLEAVERS
    public static final RegistryObject<Item> FLINT_CLEAVER = ITEMS.register("flint_cleaver", () -> new CleaverItem(1.0F, ModMaterials.FLINT, 1.5F, -3.2F, DDProperties.ItemP.FLINT));
    public static final RegistryObject<Item> IRON_CLEAVER = ITEMS.register("iron_cleaver", () -> new CleaverItem(1.25F, Tiers.IRON, 1.5F, -3.2F, DDProperties.ItemP.IRON));
    ...
    public static final RegistryObject<Item> DIAMOND_CLEAVER = ITEMS.register("diamond_cleaver", () -> new CleaverItem(1.5F, Tiers.DIAMOND, 1.5F, -3.2F, DDProperties.ItemP.DIAMOND));
    public static final RegistryObject<Item> NETHERITE_CLEAVER = ITEMS.register("netherite_cleaver", () -> new CleaverItem(1.5F, Tiers.NETHERITE, 1.5F, -3.2F, DDProperties.ItemP.NETHERITE));
