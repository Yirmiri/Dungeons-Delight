...
public class DDItems {
    ...
    public static final Supplier<Item> CLEAVED_ANCIENT_EGG = ITEMS.register("cleaved_ancient_egg", () -> new EXPFoodItem(DDProperties.ItemP.CLEAVED_ANCIENT_EGG, 10, false));
    public static final Supplier<Item> SCULK_MAYO = ITEMS.register("sculk_mayo", () -> new EXPFoodItem(DDProperties.ItemP.SCULK_MAYO, 10, false));
    ...
    public static final Supplier<Item> WARDENZOLA = ITEMS.register("wardenzola", () -> new EXPFoodItem(DDProperties.ItemP.WARDENZOLA, 10, false));
    public static final Supplier<Item> WARDENZOLA_CRUMBLES = ITEMS.register("wardenzola_crumbles", () -> new EXPFoodItem(DDProperties.ItemP.WARDENZOLA_CRUMBLES, 4, false));
    ...
    public static final Supplier<Item> GLOW_BERRY_GELATIN = ITEMS.register("glow_berry_gelatin", () -> new SlimeFoodItem(DDProperties.ItemP.GLOW_BERRY_GELATIN, 0.2F, true));
    ...
    public static final Supplier<Item> TOKAYAKI = ITEMS.register("tokayaki", () -> new EXPFoodItem(DDProperties.ItemP.TOKAYAKI, 20, true));
    ...
    public static final Supplier<Item> AU_ROTTEN_POTATOES = ITEMS.register("au_rotten_potatoes", () -> new EXPPoisonPotatoesItem(DDProperties.ItemP.AU_ROTTEN_POTATOES, 8, true));
    public static final Supplier<Item> POISONOUS_POUTINE = ITEMS.register("poisonous_poutine", () -> new EXPPoisonPotatoesItem(DDProperties.ItemP.POISONOUS_POUTINE, 4, true));
