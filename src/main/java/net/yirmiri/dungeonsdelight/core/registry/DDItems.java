...
public class DDItems {
    ...
    public static final Supplier<Item> SCULK_TART_SLICE = ITEMS.register("sculk_tart_slice", () -> new EXPFoodItem(DDProperties.ItemP.SCULK_TART_SLICE, 15, true));
    ...
    public static final Supplier<Item> MONSTER_CAKE_SLICE = ITEMS.register("monster_cake_slice", () -> new EXPFoodItem(DDProperties.ItemP.MONSTER_CAKE_SLICE, 5, true));
    ...
    public static final Supplier<Item> BLOATED_BAKED_POTATO = ITEMS.register("bloated_baked_potato", () -> new EXPPoisonPotatoesItem(DDProperties.ItemP.BLOATED_BAKED_POTATO, 4, false));
    ...
    public static final Supplier<Item> AU_ROTTEN_POTATOES = ITEMS.register("au_rotten_potatoes", () -> new EXPPoisonPotatoesItem(DDProperties.ItemP.AU_ROTTEN_POTATOES, 4, true));
    public static final Supplier<Item> POISONOUS_POUTINE = ITEMS.register("poisonous_poutine", () -> new EXPPoisonPotatoesItem(DDProperties.ItemP.POISONOUS_POUTINE, 2, true));
