...
import net.yirmiri.dungeonsdelight.common.item.food.*;
...
public class DDItems {
    ...
    //TOOLS
    public static final Supplier<Item> FLINT_CLEAVER = ITEMS.register("flint_cleaver", () -> new CleaverItem(1.0F, ModMaterials.FLINT, 2.5F, -3.1F, DDProperties.ItemP.FLINT));
    public static final Supplier<Item> IRON_CLEAVER = ITEMS.register("iron_cleaver", () -> new CleaverItem(1.25F, Tiers.IRON, 2.5F, -3.1F, DDProperties.ItemP.IRON));
    public static final Supplier<Item> GOLDEN_CLEAVER = ITEMS.register("golden_cleaver", () -> new CleaverItem(1.75F, Tiers.GOLD, 2.5F, -3.1F, DDProperties.ItemP.GOLD));
    public static final Supplier<Item> DIAMOND_CLEAVER = ITEMS.register("diamond_cleaver", () -> new CleaverItem(1.5F, Tiers.DIAMOND, 2.5F, -3.1F, DDProperties.ItemP.DIAMOND));
    public static final Supplier<Item> NETHERITE_CLEAVER = ITEMS.register("netherite_cleaver", () -> new CleaverItem(1.75F, Tiers.NETHERITE, 2.5F, -3.1F, DDProperties.ItemP.NETHERITE));
    public static final Supplier<Item> STAINED_CLEAVER = ITEMS.register("stained_cleaver", () -> new StainedCleaverItem(1.75F, DDMaterials.STAINED, 2.5F, -3.1F, DDProperties.ItemP.STAINED));
    ...
    public static final Supplier<Item> CLEAVED_ANCIENT_EGG = ITEMS.register("cleaved_ancient_egg", () -> new ConsumableItem(DDProperties.ItemP.CLEAVED_ANCIENT_EGG, false));
    public static final Supplier<Item> SCULK_MAYO = ITEMS.register("sculk_mayo", () -> new ThickDrinkableItem(DDProperties.ItemP.SCULK_MAYO, false));
    ...
    public static final Supplier<Item> WARDENZOLA = ITEMS.register("wardenzola", () -> new ConsumableItem(DDProperties.ItemP.WARDENZOLA, false));
    public static final Supplier<Item> WARDENZOLA_CRUMBLES = ITEMS.register("wardenzola_crumbles", () -> new ConsumableItem(DDProperties.ItemP.WARDENZOLA_CRUMBLES, false));
    ...
    public static final Supplier<Item> DEVILISH_EGGS = ITEMS.register("devilish_eggs", () -> new SculkFoodItem(DDProperties.ItemP.DEVILISH_EGGS, 3, false));
    ...
    public static final Supplier<Item> SCULK_TART_SLICE = ITEMS.register("sculk_tart_slice", () -> new EXPFoodItem(DDProperties.ItemP.SCULK_TART_SLICE, 30, true));
    ...
    public static final Supplier<Item> MONSTER_CAKE_SLICE = ITEMS.register("monster_cake_slice", () -> new SculkFoodItem(DDProperties.ItemP.MONSTER_CAKE_SLICE, 1, true));
    ...
    public static final Supplier<Item> BLOATED_BAKED_POTATO = ITEMS.register("bloated_baked_potato", () -> new SculkPoisonPotatoesItem(DDProperties.ItemP.BLOATED_BAKED_POTATO, 2, false));
    public static final Supplier<Item> MALICIOUS_SANDWICH = ITEMS.register("malicious_sandwich", () -> new SculkUndeadFoodItem(DDProperties.ItemP.MALICIOUS_SANDWICH, 3, false));
    ...
    public static final Supplier<Item> CROAK_MONSTER = ITEMS.register("croak_monster", () -> new SculkFoodItem(DDProperties.ItemP.CROAK_MONSTER, 1, false));
    ...
    public static final Supplier<Item> TERRINE_LOAF = ITEMS.register("terrine_loaf", () -> new SculkUndeadFoodItem(DDProperties.ItemP.TERRINE_LOAF, 1, true));
    public static final Supplier<Item> GYUDON = ITEMS.register("gyudon", () -> new SculkUndeadFoodItem(DDProperties.ItemP.GYUDON, 1, true));
    ...
    public static final Supplier<Item> CHICKEN_JOCKEY_SANDWICH = ITEMS.register("chicken_jockey_sandwich", () -> new SculkUndeadFoodItem(DDProperties.ItemP.CHICKEN_JOCKEY_SANDWICH, 1, false));
    ...
    public static final Supplier<Item> POISONOUS_POUTINE = ITEMS.register("poisonous_poutine", () -> new SculkPoisonPotatoesItem(DDProperties.ItemP.POISONOUS_POUTINE, 2, true));
