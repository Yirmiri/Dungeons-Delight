...
public class DDItems {
    ...
    //CLEAVERS
    public static final RegistryObject<Item> FLINT_CLEAVER = ITEMS.register("flint_cleaver", () -> new CleaverItem(0.75F, ModMaterials.FLINT, 1.5F, -3.2F, DDProperties.ItemP.FLINT));
    public static final RegistryObject<Item> IRON_CLEAVER = ITEMS.register("iron_cleaver", () -> new CleaverItem(1.0F, Tiers.IRON, 1.5F, -3.2F, DDProperties.ItemP.IRON));
    public static final RegistryObject<Item> GOLDEN_CLEAVER = ITEMS.register("golden_cleaver", () -> new CleaverItem(1.5F, Tiers.GOLD, 1.5F, -3.2F, DDProperties.ItemP.GOLD));
    public static final RegistryObject<Item> DIAMOND_CLEAVER = ITEMS.register("diamond_cleaver", () -> new CleaverItem(1.25F, Tiers.DIAMOND, 1.5F, -3.2F, DDProperties.ItemP.DIAMOND));
    public static final RegistryObject<Item> NETHERITE_CLEAVER = ITEMS.register("netherite_cleaver", () -> new CleaverItem(1.25F, Tiers.NETHERITE, 1.5F, -3.2F, DDProperties.ItemP.NETHERITE));
