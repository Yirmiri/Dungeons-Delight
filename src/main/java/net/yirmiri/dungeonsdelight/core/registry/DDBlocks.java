...
public class DDBlocks {
    ...
    public static final Supplier<Block> STAINED_SCRAP_CHAIN = registerBlockWOItem("stained_scrap_chain", () -> new ChainBlock(DDProperties.BlockP.STAINED_SCRAP_CHAIN));
    ...
    //WORMWOOD
    public static final Supplier<Block> WORMROOTS = registerBlock("wormroots", () -> new WormrootsBlock(DDProperties.BlockP.WORMROOTS));
