...
public class DDBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(Registries.BLOCK, DungeonsDelight.MOD_ID);

    //MISC
    public static final Supplier<Block> ROTBULB_CRATE = registerBlockWOItem("rotbulb_crate", () -> new Block(DDProperties.BlockP.WORMWOOD));
    public static final Supplier<Block> POISONOUS_POTATO_CRATE = registerBlock("poisonous_potato_crate", () -> new Block(DDProperties.BlockP.CRATE));
    public static final Supplier<Block> ROTTEN_TOMATO_CRATE = registerBlock("rotten_tomato_crate", () -> new Block(DDProperties.BlockP.CRATE));
    public static final Supplier<Block> SCULK_MAYO_BLOCK = registerBlock("sculk_mayo_block", () -> new Block(DDProperties.BlockP.SCULK_MAYO));
    ...
    public static final Supplier<Block> ROTBULB_PLANT = registerBlockWOItem("rotbulb_plant", () -> new RotbulbPlantBlock(DDProperties.BlockP.ROTBULB));
    ...
    //WORMWOOD
    public static final Supplier<Block> WORMROOT_TENDRILS = registerBlock("wormroot_tendrils", () -> new WormrootTendrilsBlock(DDProperties.BlockP.WORMROOT_TENDRILS));
    public static final Supplier<Block> WORMROOT_STALK = registerBlock("wormroot_stalk", () -> new WormrootsStalkBlock(DDProperties.BlockP.WORMWOOD));
    public static final Supplier<Block> WORMOUTH = registerBlock("wormouth", () -> new WormouthBlock(DDProperties.BlockP.WORMOUTH));
    public static final Supplier<Block> WORMROOTS_BLOCK = registerBlock("wormroots_block", () -> new Block(DDProperties.BlockP.WORMWOOD));
    public static final Supplier<Block> WORMWOOD_PLANKS = registerBlock("wormwood_planks", () -> new Block(DDProperties.BlockP.WORMWOOD));
    public static final Supplier<Block> WORMWOOD_STAIRS = registerBlock("wormwood_stairs", () -> new PublicStairBlock(WORMWOOD_PLANKS.get().defaultBlockState(), DDProperties.BlockP.WORMWOOD));
    public static final Supplier<Block> WORMWOOD_SLAB = registerBlock("wormwood_slab", () -> new SlabBlock(DDProperties.BlockP.WORMWOOD));
    public static final Supplier<Block> WORMWOOD_MOSAIC = registerBlock("wormwood_mosaic", () -> new Block(DDProperties.BlockP.WORMWOOD));
    ...
    public static final Supplier<Block> WORMWOOD_BUTTON = registerBlock("wormwood_button", () -> new WormwoodButtonBlock(DDBlockSetTypes.WORMWOOD_BLOCKSET, 20, DDProperties.BlockP.WORMWOOD_BUTTON));
    ...
    private static <T extends Block> Supplier<T> registerBlock(String id, Supplier<T> block) {
        Supplier<T> blockRegister = BLOCKS.register(id, block);
