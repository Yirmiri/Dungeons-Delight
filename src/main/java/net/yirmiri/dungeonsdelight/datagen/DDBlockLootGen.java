...
//        add(DDBlocks.WORMROOTS.get(), (Block block) -> createMultifaceBlockDrops(DDBlocks.WORMROOTS.get()));
//        dropSelf(DDBlocks.EMBEDDED_EGGS.get());
//        add(DDBlocks.HEAP_OF_ANCIENT_EGGS.get(), createAncientEggsDrops(DDBlocks.HEAP_OF_ANCIENT_EGGS.get()));
...
//        add(DDBlocks.ROTTEN_CROP.get(), createRotCropDrops(DDBlocks.ROTTEN_CROP.get(), DDItems.GUNK.get()));
//        add(DDBlocks.ROTTEN_POTATOES.get(), createRotCropDrops(DDBlocks.ROTTEN_POTATOES.get(), Items.POISONOUS_POTATO));
//        add(DDBlocks.ROTTEN_TOMATOES.get(), createRotCropDrops(DDBlocks.ROTTEN_TOMATOES.get(), ModItems.ROTTEN_TOMATO.get()));
...
//        add(DDBlocks.GUNK.get(), (Block block) -> createMultifaceBlockDrops(DDBlocks.GUNK.get()));
//        add(DDBlocks.ROTTEN_SPAWNER.get(), createRottenSpawnerDrops(DDBlocks.ROTTEN_SPAWNER.get()));
//        dropSelf(DDBlocks.STAINED_SCRAP_CHAIN.get());
...
//    }
//
//    protected LootTable.Builder createSlabItemTable(Supplier<Block> block) {
...
//    }
//
//    protected LootTable.Builder createDoorTable(Supplier<Block> block) {
