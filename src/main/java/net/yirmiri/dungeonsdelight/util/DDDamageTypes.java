...
public class DDDamageTypes {
    ...
    public static final RegistryKey<DamageType> SKULL_HEART_BLAST = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.of(DungeonsDelight.MOD_ID, "skull_heart_blast"));
