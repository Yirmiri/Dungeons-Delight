package net.yirmiri.dungeonsdelight.integration.content.twilightforest;
...
public class TFItems {
    ...
    //TOOLS
    public static final Supplier<Item> IRONWOOD_KNIFE = ITEMS.register("ironwood_knife", () -> new INKnifeItem(IntegrationIds.TWILIGHTFOREST, DDMaterials.DDCMaterials.IRONWOOD, DDProperties.ItemP.GENERIC_1.attributes(KnifeItem.createAttributes(DDMaterials.DDCMaterials.IRONWOOD, 0.5F, -2.0F))));
    public static final Supplier<Item> IRONWOOD_CLEAVER = ITEMS.register("ironwood_cleaver", () -> new INCleaverItem(IntegrationIds.TWILIGHTFOREST, 1.5F, DDMaterials.DDCMaterials.IRONWOOD, 2.0F, -3.0F, DDProperties.ItemP.GENERIC_1));

    public static final Supplier<Item> STEELEAF_KNIFE = ITEMS.register("steeleaf_knife", () -> new INKnifeItem(IntegrationIds.TWILIGHTFOREST, DDMaterials.DDCMaterials.STEELEAF, DDProperties.ItemP.GENERIC_1.attributes(KnifeItem.createAttributes(DDMaterials.DDCMaterials.STEELEAF, 0.5F, -2.0F))));
    public static final Supplier<Item> STEELEAF_CLEAVER = ITEMS.register("steeleaf_cleaver", () -> new INCleaverItem(IntegrationIds.TWILIGHTFOREST, 1.75F, DDMaterials.DDCMaterials.STEELEAF, 2.0F, -3.0F, DDProperties.ItemP.GENERIC_1));

    public static final Supplier<Item> KNIGHTMETAL_KNIFE = ITEMS.register("knightmetal_knife", () -> new INKnifeItem(IntegrationIds.TWILIGHTFOREST, DDMaterials.DDCMaterials.KNIGHTMETAL, DDProperties.ItemP.GENERIC_1.attributes(KnifeItem.createAttributes(DDMaterials.DDCMaterials.KNIGHTMETAL, 0.5F, -2.0F))));
    public static final Supplier<Item> KNIGHTMETAL_CLEAVER = ITEMS.register("knightmetal_cleaver", () -> new INCleaverItem(IntegrationIds.TWILIGHTFOREST, 1.75F, DDMaterials.DDCMaterials.KNIGHTMETAL, 2.0F, -3.0F, DDProperties.ItemP.GENERIC_1));

    public static final Supplier<Item> FIERY_KNIFE = ITEMS.register("fiery_knife", () -> new INKnifeItem(IntegrationIds.TWILIGHTFOREST, DDMaterials.DDCMaterials.FIERY, DDProperties.ItemP.GENERIC_UNCOMMON_1.attributes(KnifeItem.createAttributes(DDMaterials.DDCMaterials.FIERY, 0.5F, -2.0F))));
    public static final Supplier<Item> FIERY_CLEAVER = ITEMS.register("fiery_cleaver", () -> new INCleaverItem(IntegrationIds.TWILIGHTFOREST, 1.75F, DDMaterials.DDCMaterials.FIERY, 2.0F, -3.0F, DDProperties.ItemP.GENERIC_UNCOMMON_1));
    ...
    public static final Supplier<Item> MAZE_SMORE = ITEMS.register("maze_smore", () -> new INConsumableItem(IntegrationIds.TWILIGHTFOREST, INProperties.ItemP.MAZE_SMORE, true, false));
