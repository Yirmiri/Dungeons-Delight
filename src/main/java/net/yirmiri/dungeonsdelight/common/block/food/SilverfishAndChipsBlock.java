...
public class SilverfishAndChipsBlock extends FeastBlock {
    ...
    private static final VoxelShape PIE_SHAPE = Shapes.joinUnoptimized(PLATE_SHAPE, Block.box(3, 2, 3, 13, 8, 13), BooleanOp.OR);


    public SilverfishAndChipsBlock(Properties properties, Supplier<Item> servingItem, boolean hasLeftovers) {
