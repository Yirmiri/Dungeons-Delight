...
//        if (getUseDuration(stack, living) - timeLeft < 4 || player.getCooldowns().isOnCooldown(this)) return;
//
...
//
//            applyEffects(living, stack, cleaver);
...
//
//            int lifeGraspLevel = EnchantmentHelper.getItemEnchantmentLevel(DDUtil.getEnchantmentHolder(target, DDEnchantments.LIFE_GRASP), stack);
//
//            if (isHeated) {
//                target.setRemainingFireTicks(7 * 20);
...
//                    charge = MAX_CHARGE;
//                    isHeated = true;
//                    attacker.addEffect(new MobEffectInstance(DDEffects.RAVENOUS_RUSH, 160, 0));
//                }
//            }
//
