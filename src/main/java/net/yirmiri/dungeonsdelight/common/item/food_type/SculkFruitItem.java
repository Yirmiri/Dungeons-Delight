...
public class SculkFruitItem extends SculkFoodItem {
    private final boolean hasFoodEffectTooltip;
    private final boolean hasCustomTooltip;
    private final boolean smallFood;

    public SculkFruitItem(Properties properties, int level, boolean hasFoodEffectTooltip, boolean hasCustomTooltip, boolean smallFood) {
