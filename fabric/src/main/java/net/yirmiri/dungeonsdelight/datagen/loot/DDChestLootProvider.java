                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(DDItems.BLACK_APPLE.get()) //instead of golden apple
                                                .setWeight(15)
                                        )
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(Items.BREAD)
                                                .setWeight(20))
                                        .add(LootItem.lootTableItem(DDItems.GUNK.get()) //instead of wheat
                                                .setWeight(20)
                                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 4.0F)))
                                        )
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(DDItems.ENDELVE.get()) //instead of melon seeds
                                        .setWeight(10)
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)))
                                )
                                .add(LootItem.lootTableItem(DDItems.MANALLIUM.get()) //instead of pumpkin seeds
                                        .setWeight(10)
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)))
                                )
                                .add(LootItem.lootTableItem(DDItems.BLEET_SEEDS.get()) //instead of beetroot seeds
                                        .setWeight(10)
                                        .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F)))
                                )
                        )
